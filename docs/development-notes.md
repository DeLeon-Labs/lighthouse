...
- `data.json` is vault-specific runtime state produced through Obsidian's plugin
  data API. It contains paths, Focus membership, and UI choices. Do not copy it
  into test installations or future release output.
